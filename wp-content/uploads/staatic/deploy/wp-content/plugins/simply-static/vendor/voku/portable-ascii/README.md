...
ASCII::to_transliterate('d&eacute;j&agrave; &sigma;&sigma;&sigmaf; i&#305;ii'); // 'deja sss iiii'

// voku/Stringy
use Stringy\Stringy as S;
$stringy = S::create('d&eacute;j&agrave; &sigma;&sigma;&sigmaf; i&#305;ii');
...
```php
  echo ASCII::to_ascii('&#65533;D&uuml;sseldorf&#65533;', 'de');
  
  // will output
  // Duesseldorf

  echo ASCII::to_ascii('&#65533;D&uuml;sseldorf&#65533;', 'en');
...
</p><p id="voku-php-readme-class-methods"></p><table><tr><td><a href="#charsarraybool-replace_extra_symbols-array">charsArray</a>
...
**Parameters:**
- `bool $replace_extra_symbols [optional] <p>Add some more replacements e.g. "&pound;" with " pound ".</p>`
...
For example, German will map '&auml;' to 'ae', while other languages
...
EXAMPLE: <code>
ASCII::normalize_msword('&bdquo;Abcdef&hellip;&rdquo;'); // '"Abcdef..."'
</code>
...
EXAMPLE: <code>
ASCII::normalize_whitespace("abc-\xc2\xa0-&ouml;&auml;&uuml;-\xe2\x80\xaf-\xE2\x80\xAC", true); // "abc-\xc2\xa0-&ouml;&auml;&uuml;- -"
</code>
...
en, en_GB, or en-GB. For example, passing "de" results in "&auml;&ouml;&uuml;" mapping
to "aeoeue" rather than "aou" as in other languages.

EXAMPLE: <code>
ASCII::to_ascii('&#65533;D&uuml;sseldorf&#65533;', 'en'); // Dusseldorf
</code>
...
- `bool $replace_extra_symbols [optional]  <p>Add some more replacements e.g. "&pound;" with " pound
".</p>`
...
- `bool $replace_extra_symbols [optional]  <p>Add some more replacements e.g. "&pound;" with "
pound ".</p>`
...
**Return:**
- `string </p><p>A String that contains only ASCII characters.</p>`

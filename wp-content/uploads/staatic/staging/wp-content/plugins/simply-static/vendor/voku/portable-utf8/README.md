...
<html><body><p>[//]: # (AUTO-GENERATED BY "PHP README Helper": base file -&gt; docs/base.md)
...
+ Sebasti&aacute;n Grignoli's work - [neitanod/forceutf8](https://github.com/neitanod/forceutf8) 
...
```php
// Standard library
strtoupper('f&ograve;&ocirc;b&agrave;&#345;');       // 'F&ograve;&ocirc;B&agrave;&#345;'
strlen('f&ograve;&ocirc;b&agrave;&#345;');           // 10

// mbstring 
// WARNING: if you don't use a polyfill like "Portable UTF-8", you need to install the php-extension "mbstring" on your server
mb_strtoupper('f&ograve;&ocirc;b&agrave;&#345;');    // 'F&Ograve;&Ocirc;B&Agrave;&#344;'
mb_strlen('f&ograve;&ocirc;b&agrave;&#345;');        // '6'

// Portable UTF-8
use voku\helper\UTF8;
UTF8::strtoupper('f&ograve;&ocirc;b&agrave;&#345;');    // 'F&Ograve;&Ocirc;B&Agrave;&#344;'
UTF8::strlen('f&ograve;&ocirc;b&agrave;&#345;');        // '6'

// voku/Stringy
use Stringy\Stringy as S;
$stringy = S::create('f&ograve;&ocirc;b&agrave;&#345;');
$stringy-&gt;toUpperCase();    // 'F&Ograve;&Ocirc;B&Agrave;&#344;'
$stringy-&gt;length();         // '6'
```
...
```php
  echo UTF8::cleanup('&#65533;D&Atilde;&frac14;sseldorf&#65533;');
...
```php
  $string = 'string <strong>with utf-8 chars &aring;&egrave;&auml;</strong> - doo-bee doo-bee dooh';
...
```php
  ...
  echo UTF8::fix_utf8('D&Atilde;&frac14;sseldorf');
  echo UTF8::fix_utf8('&Atilde;&curren;');
...
</p><p id="voku-php-readme-class-methods"></p><table><tr><td><a href="#accessstring-str-int-pos-string-encoding-string">access</a>
...
EXAMPLE: <code>UTF8::access('f&ograve;&ocirc;', 1); // '&ograve;'</code>
...
EXAMPLE: <code>UTF8::add_bom_to_string('f&ograve;&ocirc;'); // "\xEF\xBB\xBF" . 'f&ograve;&ocirc;'</code>
...
EXAMPLE: <code>UTF8::chr_map([UTF8::class, 'strtolower'], '&Kappa;&#8057;&sigma;&mu;&epsilon;'); // ['&kappa;','&#8057;', '&sigma;', '&mu;', '&epsilon;']</code>
...
EXAMPLE: <code>UTF8::chr_to_decimal('&sect;'); // 0xa7</code>
...
EXAMPLE: <code>UTF8::chr_to_hex('&sect;'); // U+00a7</code>
...
EXAMPLE: <code>UTF8::chunk_split('ABC-&Ouml;&Auml;&Uuml;-&#20013;&#25991;&#31354;&#30333;-&kappa;&#8057;&sigma;&mu;&epsilon;', 3); // "ABC\r\n-&Ouml;&Auml;\r\n&Uuml;-&#20013;\r\n&#25991;&#31354;&#30333;\r\n-&kappa;&#8057;\r\n&sigma;&mu;&epsilon;"</code>
...
EXAMPLE: <code>UTF8::clean("\xEF\xBB\xBF&bdquo;Abcdef\xc2\xa0\x20&hellip;&rdquo; &mdash; &#128515; - D&Atilde;&frac14;sseldorf", true, true); // '&bdquo;Abcdef&nbsp; &hellip;&rdquo; &mdash; &#128515; - D&Atilde;&frac14;sseldorf'</code>
...
EXAMPLE: <code>UTF8::cleanup("\xEF\xBB\xBF&bdquo;Abcdef\xc2\xa0\x20&hellip;&rdquo; &mdash; &#128515; - D&Atilde;&frac14;sseldorf", true, true); // '&bdquo;Abcdef&nbsp; &hellip;&rdquo; &mdash; &#128515; - D&uuml;sseldorf'</code>
...
EXAMPLE: <code>
UTF8::codepoints('&kappa;&ouml;&ntilde;'); // array(954, 246, 241)
// ... OR ...
UTF8::codepoints('&kappa;&ouml;&ntilde;', true); // array('U+03ba', 'U+00f6', 'U+00f1')
</code>
...
EXAMPLE: <code>UTF8::count_chars('&kappa;a&kappa;b&kappa;c'); // array('&kappa;' =&gt; 3, 'a' =&gt; 1, 'b' =&gt; 1, 'c' =&gt; 1)</code>
...
**Return:**
- `int[] </p><p>An associative array of Character as keys and
...
EXAMPLE: <code>UTF8::decimal_to_chr(931); // '&Sigma;'</code>
...
- `string $replacer_for_skipped_text [optional] <p>Default: &hellip;</p>`
- `string $encoding [optional] <p>Set the charset for e.g. "mb_" function</p>`
...
EXAMPLE: <code>UTF8::filter(array("\xE9", '&agrave;', 'a')); // array('&eacute;', 'a&#768;', 'a')</code>
...
## filter_input_array(int $type, array|null $definition, bool $add_empty): array<string>|false|null
<a href="#voku-php-readme-class-methods">&uarr;</a>
...
## filter_var_array(array $data, array|int $definition, bool $add_empty): array<string>|false|null
<a href="#voku-php-readme-class-methods">&uarr;</a>
...
$data = [
    'name' =&gt; '&kappa;&#8057;&sigma;&mu;&epsilon;',
    'age' =&gt; '18',
    'email' =&gt; 'foo@bar.de'
];

UTF8::filter_var_array($data, $filters, true); // ['name' =&gt; '&Kappa;&#972;&sigma;&mu;&epsilon;', 'age' =&gt; 18, 'email' =&gt; 'foo@bar.de']
</code>
...
EXAMPLE: <code>UTF8::fits_inside('&kappa;&#8057;&sigma;&mu;&epsilon;', 6); // false</code>
...
EXAMPLE: <code>UTF8::fix_simple_utf8('D&Atilde;&frac14;sseldorf'); // 'D&uuml;sseldorf'</code>
...
EXAMPLE: <code>UTF8::fix_utf8('F&Atilde;&Acirc;&Acirc;&Acirc;&Acirc;&copy;d&Atilde;&Acirc;&Acirc;&Acirc;&Acirc;&copy;ration'); // 'F&eacute;d&eacute;ration'</code>
...
EXAMPLE: <code>UTF8::hex_to_chr('U+00a7'); // '&sect;'</code>
...
EXAMPLE: <code>UTF8::htmlentities(''); // '&lt;&#30333;-&ouml;&auml;&uuml;&gt;'</code>
...
EXAMPLE: <code>UTF8::htmlspecialchars(''); // '&lt;&#30333;-&ouml;&auml;&uuml;&gt;'</code>
...
EXAMPLE: <code>UTF8::is_json('{"array":[1,"&yen;","&auml;"]}'); // true</code>
...
EXAMPLE: <code>
UTF8::is_utf8(['I&ntilde;t&euml;rn&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n', 'foo']); // true
//
UTF8::is_utf8(["I&ntilde;t&euml;rn&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n\xA0\xA1", 'bar']); // false
</code>
...
EXAMPLE: <code>UTF8::json_decode('[1,"\u00a5","\u00e4"]'); // array(1, '&yen;', '&auml;')</code>
...
EXAMPLE: <code>UTF8::json_encode(array(1, '&yen;', '&auml;')); // '[1,"\u00a5","\u00e4"]'</code>
...
EXAMPLE: <code>UTF8::lcfirst('&Ntilde;T&Euml;RN&Acirc;TI&Ocirc;N&Agrave;LIZ&AElig;TI&Oslash;N'); // &ntilde;T&Euml;RN&Acirc;TI&Ocirc;N&Agrave;LIZ&AElig;TI&Oslash;N</code>
...
EXAMPLE: <code>UTF8::max('abc-&auml;&ouml;&uuml;-&#20013;&#25991;&#31354;&#30333;'); // '&oslash;'</code>
...
EXAMPLE: <code>UTF8::max_chr_width('Int&euml;rn&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n'); // 2</code>
...
EXAMPLE: <code>UTF8::min('abc-&auml;&ouml;&uuml;-&#20013;&#25991;&#31354;&#30333;'); // '-'</code>
...
EXAMPLE: <code>UTF8::normalize_msword('&bdquo;Abcdef&hellip;&rdquo;'); // '"Abcdef..."'</code>
...
EXAMPLE: <code>UTF8::normalize_whitespace("abc-\xc2\xa0-&ouml;&auml;&uuml;-\xe2\x80\xaf-\xE2\x80\xAC", true); // "abc-\xc2\xa0-&ouml;&auml;&uuml;- -"</code>
...
**Parameters:**
- `string $chr <p>The character of which to calculate code point.</p><p></p>`
- `string $encoding [optional] <p>Set the charset for e.g. "mb_" function</p>`
...
EXAMPLE: <code>
UTF8::parse_str('I&ntilde;t&euml;rn&acirc;ti&ocirc;n&eacute;&agrave;liz&aelig;ti&oslash;n=&#28204;&#35430;&amp;arr[]=foo+&#28204;&#35430;&amp;arr[]=&#3713;&#3762;&#3737;&#3735;&#3771;&#3732;&#3754;&#3757;&#3738;', $array);
echo $array['I&ntilde;t&euml;rn&acirc;ti&ocirc;n&eacute;&agrave;liz&aelig;ti&oslash;n']; // '&#28204;&#35430;'
</code>
...
EXAMPLE: <code>UTF8::range('&kappa;', '&zeta;'); // array('&kappa;', '&iota;', '&theta;', '&eta;', '&zeta;',)</code>
...
EXAMPLE: <code>UTF8::rawurldecode('tes%20&ouml;&auml;&uuml;%20\u00edtest+test'); // 'tes &ouml;&auml;&uuml; &iacute;test+test'</code>

e.g:
'test+test'                     =&gt; 'test+test'
'D&uuml;sseldorf'               =&gt; 'D&uuml;sseldorf'
'D%FCsseldorf'                  =&gt; 'D&uuml;sseldorf'
'D&uuml;sseldorf'               =&gt; 'D&uuml;sseldorf'
'D%26%23xFC%3Bsseldorf'         =&gt; 'D&uuml;sseldorf'
'D&Atilde;&frac14;sseldorf'                   =&gt; 'D&uuml;sseldorf'
'D%C3%BCsseldorf'               =&gt; 'D&uuml;sseldorf'
'D%C3%83%C2%BCsseldorf'         =&gt; 'D&uuml;sseldorf'
'D%25C3%2583%25C2%25BCsseldorf' =&gt; 'D&uuml;sseldorf'
...
EXAMPLE: <code>UTF8::remove_bom("\xEF\xBB\xBF&Mu;&pi;&omicron;&rho;&#974; &nu;&alpha;"); // '&Mu;&pi;&omicron;&rho;&#974; &nu;&alpha;'</code>
...
EXAMPLE: <code>UTF8::remove_duplicates('&ouml;&auml;&uuml;-&kappa;&#8057;&sigma;&mu;&epsilon;&kappa;&#8057;&sigma;&mu;&epsilon;-&auml;&ouml;&uuml;', '&kappa;&#8057;&sigma;&mu;&epsilon;'); // '&ouml;&auml;&uuml;-&kappa;&#8057;&sigma;&mu;&epsilon;-&auml;&ouml;&uuml;'</code>
...
EXAMPLE: <code>UTF8::remove_invisible_characters("&kappa;&#8057;&sigma;\0&mu;&epsilon;"); // '&kappa;&#8057;&sigma;&mu;&epsilon;'</code>
...
EXAMPLE: <code>UTF8::single_chr_html_encode('&kappa;'); // '&kappa;'</code>
...
- `string $encoding [optional] </p><p>Set the charset for e.g. "mb_" function</p>`
...
EXAMPLE: <code>
UTF8::str_ends_with('BeginMiddle&Kappa;&#8057;&sigma;&mu;&epsilon;', '&Kappa;&#8057;&sigma;&mu;&epsilon;'); // true
UTF8::str_ends_with('BeginMiddle&Kappa;&#8057;&sigma;&mu;&epsilon;', '&kappa;&#8057;&sigma;&mu;&epsilon;'); // false
</code>
...
EXAMPLE: <code>
UTF8::str_iends_with('BeginMiddle&Kappa;&#8057;&sigma;&mu;&epsilon;', '&Kappa;&#8057;&sigma;&mu;&epsilon;'); // true
UTF8::str_iends_with('BeginMiddle&Kappa;&#8057;&sigma;&mu;&epsilon;', '&kappa;&#8057;&sigma;&mu;&epsilon;'); // true
</code>
...
EXAMPLE: <code>
UTF8::str_ireplace('lIz&AElig;', 'lise', 'I&ntilde;t&euml;rn&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n'); // 'I&ntilde;t&euml;rn&acirc;ti&ocirc;n&agrave;liseti&oslash;n'
</code>
...
EXAMPLE: <code>
UTF8::str_istarts_with('&Kappa;&#8057;&sigma;&mu;&epsilon;MiddleEnd', '&Kappa;&#8057;&sigma;&mu;&epsilon;'); // true
UTF8::str_istarts_with('&Kappa;&#8057;&sigma;&mu;&epsilon;MiddleEnd', '&kappa;&#8057;&sigma;&mu;&epsilon;'); // true
</code>
...
- `string $str_add_on [optional] <p>Default: &hellip;</p>`
- `string $encoding [optional] <p>Set the charset for e.g. "mb_" function</p>`
...
EXAMPLE: <code>UTF8::str_limit_after_word('f&ograve;&ocirc; b&agrave;&#345; f&ograve;&ocirc;', 8, ''); // 'f&ograve;&ocirc; b&agrave;&#345;'</code>
...
EXAMPLE: <code>UTF8::str_repeat("&deg;~\xf0\x90\x28\xbc", 2); // '&deg;~&eth;&#144;(&frac14;&deg;~&eth;&#144;(&frac14;'</code>
...
EXAMPLE: <code>UTF8::str_shuffle('f&ograve;&ocirc; b&agrave;&#345; f&ograve;&ocirc;'); // '&agrave;&ograve;&ocirc;&#345;b ff&ograve;&ocirc; '</code>
...
**Return:**
- `list<list>&gt; <p>An array containing chunks of the input.</p>`
...
EXAMPLE: <code>
UTF8::str_starts_with('&Kappa;&#8057;&sigma;&mu;&epsilon;MiddleEnd', '&Kappa;&#8057;&sigma;&mu;&epsilon;'); // true
UTF8::str_starts_with('&Kappa;&#8057;&sigma;&mu;&epsilon;MiddleEnd', '&kappa;&#8057;&sigma;&mu;&epsilon;'); // false
</code>
...
EXAMPLE: <code>UTF8::str_to_words('&#20013;&#25991;&#31354;&#30333; o&ouml;&auml;&uuml;#s', '#') // array('', '&#20013;&#25991;&#31354;&#30333;', ' ', 'o&ouml;&auml;&uuml;#s', '')</code>
...
//
UTF8::str_word_count('&#20013;&#25991;&#31354;&#30333; &ouml;&auml;&uuml; abc#c'); // 4
UTF8::str_word_count('&#20013;&#25991;&#31354;&#30333; &ouml;&auml;&uuml; abc#c', 0, '#'); // 3

// format: 1 -&gt; return words (array)
//
UTF8::str_word_count('&#20013;&#25991;&#31354;&#30333; &ouml;&auml;&uuml; abc#c', 1); // array('&#20013;&#25991;&#31354;&#30333;', '&ouml;&auml;&uuml;', 'abc', 'c')
UTF8::str_word_count('&#20013;&#25991;&#31354;&#30333; &ouml;&auml;&uuml; abc#c', 1, '#'); // array('&#20013;&#25991;&#31354;&#30333;', '&ouml;&auml;&uuml;', 'abc#c')

// format: 2 -&gt; return words with offset (array)
//
UTF8::str_word_count('&#20013;&#25991;&#31354;&#30333; &ouml;&auml;&uuml; ab#c', 2); // array(0 =&gt; '&#20013;&#25991;&#31354;&#30333;', 5 =&gt; '&ouml;&auml;&uuml;', 9 =&gt; 'abc', 13 =&gt; 'c')
UTF8::str_word_count('&#20013;&#25991;&#31354;&#30333; &ouml;&auml;&uuml; ab#c', 2, '#'); // array(0 =&gt; '&#20013;&#25991;&#31354;&#30333;', 5 =&gt; '&ouml;&auml;&uuml;', 9 =&gt; 'abc#c')
</code>
...
EXAMPLE: <code>UTF8::strcasecmp("i&ntilde;t&euml;rn&acirc;ti&ocirc;n\n&agrave;liz&aelig;ti&oslash;n", "I&ntilde;t&euml;rn&acirc;ti&ocirc;n\n&agrave;liz&aelig;ti&oslash;n"); // 0</code>
...
EXAMPLE: <code>UTF8::strcmp("i&ntilde;t&euml;rn&acirc;ti&ocirc;n\n&agrave;liz&aelig;ti&oslash;n", "i&ntilde;t&euml;rn&acirc;ti&ocirc;n\n&agrave;liz&aelig;ti&oslash;n"); // 0</code>
...
EXAMPLE: <code>UTF8::string(array(246, 228, 252)); // '&ouml;&auml;&uuml;'</code>
...
EXAMPLE: <code>UTF8::strip_tags("<span>&kappa;&#8057;&sigma;&mu;&epsilon;\xa0\xa1</span>"); // '&kappa;&#8057;&sigma;&mu;&epsilon;'</code>
...
EXAMPLE: <code>UTF8::strip_whitespace('   &Omicron;     &sigma;&upsilon;&gamma;&gamma;&rho;&alpha;&phi;&#941;&alpha;&sigmaf;  '); // '&Omicron;&sigma;&upsilon;&gamma;&gamma;&rho;&alpha;&phi;&#941;&alpha;&sigmaf;'</code>
...
EXAMPLE: <code>UTF8::stripos('a&sigma;&sigma;b', '&Sigma;&Sigma;'); // 1</code> (&sigma;&sigma; == &Sigma;&Sigma;)
...
EXAMPLE: <code>
$str = 'i&ntilde;t&euml;rn&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n';
$search = 'N&Acirc;T';

UTF8::stristr($str, $search)); // 'n&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n'
UTF8::stristr($str, $search, true)); // 'i&ntilde;t&euml;r'
</code>
...
EXAMPLE: <code>UTF8::strlen("I&ntilde;t&euml;rn&acirc;ti&ocirc;n\xE9&agrave;liz&aelig;ti&oslash;n")); // 20</code>
...
EXAMPLE: <code>
UTF8::strcasecmp("i&ntilde;t&euml;rn&acirc;ti&ocirc;n\n&agrave;liz&aelig;ti&oslash;n321", "i&ntilde;t&euml;rn&acirc;ti&ocirc;n\n&agrave;liz&aelig;ti&oslash;n123", 5); // 0
</code>
...
EXAMPLE: <code>
UTF8::strncmp("I&ntilde;t&euml;rn&acirc;ti&ocirc;n\n&agrave;liz&aelig;ti&oslash;n321", "I&ntilde;t&euml;rn&acirc;ti&ocirc;n\n&agrave;liz&aelig;ti&oslash;n123", 5); // 0
</code>
...
EXAMPLE: <code>UTF8::strpos('ABC-&Ouml;&Auml;&Uuml;-&#20013;&#25991;&#31354;&#30333;-&#20013;&#25991;&#31354;&#30333;', '&#20013;'); // 8</code>
...
EXAMPLE: <code>UTF8::strrchr('&kappa;&#8057;&sigma;&mu;&epsilon;&kappa;&#8057;&sigma;&mu;&epsilon;-&auml;&ouml;&uuml;', '&kappa;&#8057;&sigma;&mu;&epsilon;'); // '&kappa;&#8057;&sigma;&mu;&epsilon;-&auml;&ouml;&uuml;'</code>
...
EXAMPLE: <code>UTF8::strrev('&kappa;-&ouml;&auml;&uuml;'); // '&uuml;&auml;&ouml;-&kappa;'</code>
...
EXAMPLE: <code>UTF8::strrichr('A&kappa;&#8057;&sigma;&mu;&epsilon;&kappa;&#8057;&sigma;&mu;&epsilon;-&auml;&ouml;&uuml;', 'a&kappa;&#8057;&sigma;&mu;&epsilon;'); // 'A&kappa;&#8057;&sigma;&mu;&epsilon;&kappa;&#8057;&sigma;&mu;&epsilon;-&auml;&ouml;&uuml;'</code>
...
EXAMPLE: <code>UTF8::strripos('ABC-&Ouml;&Auml;&Uuml;-&#20013;&#25991;&#31354;&#30333;-&#20013;&#25991;&#31354;&#30333;', '&#20013;'); // 13</code>
...
EXAMPLE: <code>UTF8::strrpos('ABC-&Ouml;&Auml;&Uuml;-&#20013;&#25991;&#31354;&#30333;-&#20013;&#25991;&#31354;&#30333;', '&#20013;'); // 13</code>
...
EXAMPLE: <code>UTF8::strspn('i&ntilde;t&euml;rn&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n', 'it&ntilde;'); // '3'</code>
...
UTF8::strstr($str, $search)); // 'n&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n'
UTF8::strstr($str, $search, true)); // 'i&ntilde;t&euml;r'
</code>
...
EXAMPLE: <code>UTF8::strtolower('D&Eacute;J&Agrave; &Sigma;&sigma;&sigmaf; I&#305;&#304;i'); // 'd&eacute;j&agrave; &sigma;&sigma;&sigmaf; i&#305;ii'</code>
...
EXAMPLE: <code>UTF8::strtoupper('D&eacute;j&agrave; &Sigma;&sigma;&sigmaf; I&#305;&#304;i'); // 'D&Eacute;J&Agrave; &Sigma;&Sigma;&Sigma; II&#304;I'</code>
...
EXAMPLE: <code>UTF8::strwidth("I&ntilde;t&euml;rn&acirc;ti&ocirc;n\xE9&agrave;liz&aelig;ti&oslash;n")); // 21</code>
...
<i>length</i> parameters.<p>If <i>str</i> is shorter than <i>offset</i>
characters long, <b>FALSE</b> will be returned.`
...
**Parameters:**
- `string $str1 </p><p>The main string being compared.</p>`
...
EXMAPLE: <code>
UTF8::substr_ileft('&Kappa;&#8057;&sigma;&mu;&epsilon;MiddleEnd', '&Kappa;&#8057;&sigma;&mu;&epsilon;'); // 'MiddleEnd'
UTF8::substr_ileft('&Kappa;&#8057;&sigma;&mu;&epsilon;MiddleEnd', '&kappa;&#8057;&sigma;&mu;&epsilon;'); // 'MiddleEnd'
</code>
...
EXAMPLE: <code>
UTF8::substr_iright('BeginMiddle&Kappa;&#8057;&sigma;&mu;&epsilon;', '&Kappa;&#8057;&sigma;&mu;&epsilon;'); // 'BeginMiddle'
UTF8::substr_iright('BeginMiddle&Kappa;&#8057;&sigma;&mu;&epsilon;', '&kappa;&#8057;&sigma;&mu;&epsilon;'); // 'BeginMiddle'
</code>
...
**Return:**
- `string <p>Return the sub-string.</p><p>`
...
EXAMPLE: <code>
UTF8::substr_left('&Kappa;&#8057;&sigma;&mu;&epsilon;MiddleEnd', '&Kappa;&#8057;&sigma;&mu;&epsilon;'); // 'MiddleEnd'
UTF8::substr_left('&Kappa;&#8057;&sigma;&mu;&epsilon;MiddleEnd', '&kappa;&#8057;&sigma;&mu;&epsilon;'); // '&Kappa;&#8057;&sigma;&mu;&epsilon;MiddleEnd'
</code>

**Parameters:**
- `string $haystack </p><p>The string to search in.</p>`
- `string $needle <p>The substring to search for.</p>`
...
EXAMPLE: <code>UTF8::substr_replace(array('I&ntilde;t&euml;rn&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n', 'foo'), '&aelig;', 1); // array('I&aelig;&ntilde;t&euml;rn&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n', 'f&aelig;oo')</code>
...
EXAMPLE: <code>
UTF8::substr_right('BeginMiddle&Kappa;&#8057;&sigma;&mu;&epsilon;', '&Kappa;&#8057;&sigma;&mu;&epsilon;'); // 'BeginMiddle'
UTF8::substr_right('BeginMiddle&Kappa;&#8057;&sigma;&mu;&epsilon;', '&kappa;&#8057;&sigma;&mu;&epsilon;'); // 'BeginMiddle&Kappa;&#8057;&sigma;&mu;&epsilon;'
</code>
...
EXAMPLE: <code>UTF8::swapCase('d&eacute;J&Agrave; &sigma;&sigma;&sigmaf; i&#305;II'); // 'D&Eacute;j&agrave; &Sigma;&Sigma;&Sigma; IIii'</code>
...
EXAMPLE: <code>UTF8::to_ascii('d&eacute;j&agrave; &sigma;&sigma;&sigmaf; i&#305;ii'); // 'deja sss iiii'</code>
...
We can only use the original-function, if we use UTF8::trim('   -ABC-&#20013;&#25991;&#31354;&#30333;-  '); // '-ABC-&#20013;&#25991;&#31354;&#30333;-'
...
EXAMPLE: <code>UTF8::ucfirst('&ntilde;t&euml;rn&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n foo'); // '&Ntilde;t&euml;rn&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n foo'</code>
...
EXAMPLE: <code>UTF8::ucwords('i&ntilde;t &euml;rn &acirc;Ti &ocirc;n&agrave; liz &aelig;ti &oslash;n'); // 'I&ntilde;t &Euml;rn &Acirc;Ti &Ocirc;n&agrave; Liz &AElig;ti &Oslash;n'</code>
...
EXAMPLE: <code>UTF8::urldecode('tes%20&ouml;&auml;&uuml;%20\u00edtest+test'); // 'tes &ouml;&auml;&uuml; &iacute;test test'</code>
...
EXAMPLE: <code>UTF8::words_limit('f&ograve;&ocirc; b&agrave;&#345; f&ograve;&ocirc;', 2, ''); // 'f&ograve;&ocirc; b&agrave;&#345;'</code>
...
EXAMPLE: <code>UTF8::wordwrap('I&ntilde;t&euml;rn&acirc;ti&ocirc;n&agrave;liz&aelig;ti&oslash;n', 2, '<br>', true)); // 'I&ntilde;<br>t&euml;<br>rn<br>&acirc;t<br>i&ocirc;<br>n&agrave;<br>li<br>z&aelig;<br>ti<br>&oslash;n'</code>
...
</string></string></list></list></string></string></string></string></string></array-key></array-key></string></string></string></string></string></string></string></string></string></body></html>

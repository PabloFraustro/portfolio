...
- ASCII::to_ascii() -&gt; fix for languages with multi-length-special-char (e.g. Greek -&gt; '&epsilon;&iota;' =&gt; 'i')
...
- "ascii_extras" -&gt; convert the static content into ascii 
   -&gt; e.g.: instead of replacing "+" with "pi&ugrave;" we use "piu" (Italian), because we want to use ascii anyway
